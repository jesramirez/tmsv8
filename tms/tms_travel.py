...
class tms_travel(osv.osv):
    ...
    _columns = {
        ...
        'office_id'       : fields.many2one('tms.office', 'Office', ondelete='restrict', required=True, readonly=False, states={'cancel':[('readonly',True)], 'done':[('readonly',True)], 'closed':[('readonly',True)]}),
    ...
    _sql_constraints = [
        ('name_uniq', 'unique(office_id,name)', 'Travel number must be unique !'),
        ]
    _order = "date desc"
    ...
    def copy(self, cr, uid, id, default=None, context=None):
        ...
        default.update({
                        ...
                        'state'			: 'draft',
                        'waybill_ids'   : False, 
                        'default_waybill_id': False,
                        'fuelvoucher_ids': False, 
                        'advance_ids'   : False,
                        'cancelled_by'  : False,
                        'date_cancelled': False,
                        'dispatched_by' : False, 
                        'date_dispatched': False,
                        'done_by'       : False, 
                        'date_done'     : False,
                        'closed_by'     : False,
                        'date_closed'   : False,
        ...
        return super(tms_travel, self).copy(cr, uid, id, default, context)
