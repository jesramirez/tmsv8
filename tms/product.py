    ...
    def _check_tms_product(self, cr, uid, ids, context=None):
        for record in self.browse(cr, uid, ids, context=context): 
            if record.tms_category in ['transportable']:
                return (record.type=='service'  and record.supply_method =='buy' and not record.sale_ok and not record.purchase_ok)
            elif record.tms_category in ['freight', 'move','insurance','highway_tolls','other']:
                return (record.type=='service'  and record.supply_method =='buy' and record.sale_ok)
                ...
                return (record.type=='service'  and record.supply_method =='buy' and record.purchase_ok)
            elif record.tms_category in ['fuel']:
                return (record.type=='product' and record.supply_method =='buy' and record.purchase_ok)
