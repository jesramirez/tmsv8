...
class tms_expense(osv.osv):
    ...
    _columns = {
        ...
        'office_id': fields.many2one('tms.office', 'Office', required=True, readonly=True, states={'draft': [('readonly', False)]}),
    ...
    def create(self, cr, uid, vals, context=None):
        values = vals
        if 'office_id' in vals and vals['office_id']:
            shop = self.pool.get('tms.office').browse(cr, uid, [vals['office_id']])[0]
...
class tms_expense_line(osv.osv):
    ...
    _columns = {
        ...
        'office_id'           : fields.related('expense_id', 'office_id', type='many2one', relation='tms.office', string='Office', store=True, readonly=True),
...
class tms_expense_invoice(osv.osv_memory):
                ...
                for expense in expense_obj.browse(cr, uid, expenses_ids):
                    ...
                    if expense.amount_advance:
                        move_line = (0,0, {
                                ...
                                'office_id'     : expense.office_id.id,
    ...
    def create_supplier_invoice(self, cr, uid, line, context=None):
        ...
        inv_line = (0,0, {
            ...
            'office_id'          : line.expense_id.office_id.id,
            })
